...
<html lang="ru">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Orders | Nazox - Responsive Bootstrap 4 Admin Dashboard</title>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="ecommerce-orders.html"><i class="ri-wallet-2-line align-middle mr-1"></i> Таблица товаров</a>
                                <a class="dropdown-item" href="ecommerce-orders.html"><i class="ri-wallet-2-line align-middle mr-1"></i> Таблица заказов</a>
                                ...
                                <a class="dropdown-item text-danger" href="auth-login.html"><i class="ri-shut-down-line align-middle mr-1 text-danger"></i> Выйти</a>
                            </div>
                        </div>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © Eblevorot.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-right d-none d-sm-block">    
                                    Made with <i class="mdi mdi-heart text-danger"></i> love
                                </div>
                            </div>
                        </div>
                    </div>
